                    ...
                    return new ListCell<CardVideo>() {
                        ...
                        protected void updateItem(CardVideo item, boolean empty) {
                            ...
                            if (item != null) {
                                ...
                                Label nameLabel = new Label("Nombre: " + item.getTitulo());


                                // Agrega componentes al HBox
